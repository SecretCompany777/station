...
<div align="center"><img src="https://files.catbox.moe/1wmw95.jpg"></div>
...
```json
"dependencies": {
    "secret-company": "npm:secret-company@latest"
}
```
or install in terminal:
```
npm install secret-company@npm:secret-company
```

Then import the default function in your code:
```ts 
// type esm
import makeWASocket from 'secret-company'
```

```js
// type cjs
const { default: makeWASocket } = require("secret-company")
```
